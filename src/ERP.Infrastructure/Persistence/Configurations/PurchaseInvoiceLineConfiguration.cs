...
namespace ERP.Infrastructure.Persistence.Configurations
{
    public class PurchaseInvoiceLineConfiguration : IEntityTypeConfiguration<PurchaseInvoiceLine>
    {
        public void Configure(EntityTypeBuilder<PurchaseInvoiceLine> builder)
        {
            ...
            builder.Property(x => x.Quantity).HasColumnType("numeric(18,4)").HasColumnName("quantity");
            builder.Property(x => x.UnitPrice).HasColumnType("numeric(18,4)").HasColumnName("unit_price");
            builder.Property(x => x.TaxRate).HasColumnType("numeric(5,4)").HasColumnName("tax_rate");
            builder.Property(x => x.TaxId).HasColumnName("tax_id");

            builder.HasOne<PurchaseInvoice>()
                .WithMany(nameof(PurchaseInvoice.PurchaseInvoiceLines))
